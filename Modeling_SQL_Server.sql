...
FILENAME = 'D:\SQL\NTI_Final_Project\Stock_Market_Data.mdf'
)
LOG ON(
NAME = Stock_Market_Log,
FILENAME = 'D:\SQL\NTI_Final_Project\Stock_Market_Log.mdf'
);
...
SELECT DISTINCT ticker FROM dbo.Final_Data;
...
SELECT 
    ...
    ROUND(STDEV(sp.Price_Close), 4) AS STD_DEV_Close,
